...
public:
    ...
    /** Called for every block record.  */
    virtual void addBlockRecord(const DRW_Block_Record& data) = 0;
    ...
    virtual void copyInsert(const DRW_Insert& data) = 0;
    ...
    virtual bool findLayer(UTF8STRING layerName, DRW_Layer* lr) = 0;
    virtual int findLayerColor(UTF8STRING layerName) = 0;
    virtual int findLayerLineWidth(UTF8STRING layerName) = 0;
    virtual int findHeaderInt(UTF8STRING headerEntry) = 0;
    virtual UTF8STRING findHeaderString(UTF8STRING headerEntry) = 0;
    virtual UTF8STRING findLayerLineType(UTF8STRING layerName) = 0;
    virtual void writeBlocksSVG(boundBox* drawExtent) = 0;
    virtual void writeEntitiesSVG(DRW_Header header, boundBox* drawExtent) = 0;
    virtual void calcBlockExtents(double* xMin, double* xMax, double* yMin, double* yMax) = 0;
    virtual void calcEntityExtents(double* xMin, double* xMax, double* yMin, double* yMax)= 0;
    //virtual void compareExtents(double newMin, double newMax, double* currMin, double* currMax) = 0;
};
