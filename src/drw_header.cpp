...
double DRW_Header::headerDouble(std::string headerVal)
{
    double varDouble;
    varDouble = 0.0;
    getDouble(headerVal, &varDouble);
    return varDouble;
}

int DRW_Header::headerInt(std::string headerVal)
{
    int varInt;
    varInt = 0;
    getInt(headerVal, &varInt);
    return varInt;
}

UTF8STRING DRW_Header::headerString(std::string headerVal)
{
    UTF8STRING varStr;
    varStr = " ";
    getStr(headerVal, &varStr);
    return varStr;

}

DRW_Coord DRW_Header::headerCoord(std::string headerVal)
{
     DRW_Coord varCoord;
     varCoord.x = varCoord.y = varCoord.z = 0;
     getCoord(headerVal, &varCoord);
     return varCoord;
}
