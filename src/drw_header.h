...
public:
    ...
    double headerDouble(std::string headerVal);
    int headerInt(std::string headerVal);
    DRW_Coord headerCoord(std::string headerVal);
    UTF8STRING headerString(std::string headerVal);
